...
namespace System.Collections.ObjectModel
{
    ...
    public class RangeObservableCollection<T> : ObservableCollection<T>
    {
        ...
        /// <param name="collection">The collection whose elements should be inserted into the 'ListT'. The collection itself cannot be null, but it can contain elements that are null, if type T is a reference type.</param>
        /// <exception cref="ArgumentNullException"><paramref name="collection"/> is null.</exception>
